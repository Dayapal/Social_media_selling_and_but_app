import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Edit, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, Star, StarIcon, TrashIcon, TrendingUp, User, WalletIcon, XCircle } from 'lucide-react';
    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
      ...
      {userListings.length === 0 ? (
        ...
        p-16 text-center'>
          ...
          <p className='text-gray-600 mb-6'>Start By creating your firsr listing</p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {userListings.map((listing) => (
            <div key={listing.id} className='bg-white rounded-lg border border-gray-200
            hover:shadow-lg shadow-gray-200/70 transition-shadow '>
              <div className='p-6 '>
                <div className='flex items-center gap-4 justify-between mb-4'>
                  ...
                  <div className='flex-1'>
                    <div className='flex justify-between items-start'>
                      ...
                      text-gray-800'>{listing.title}</h3>
                                ...
                                <span className={
                                  listing.isCredentialSubmitted ?
                                    listing.isCredentialVerified ?
                                      listing.isCredentialChanged ? "text-green-600" :
                                        "text-indigo-600" : "text-shadow-slate-600" : "text-red-600"

                                }>
                                  {listing.isCredentialSubmitted ?
                                    listing.isCredentialVerified ?
                                      listing.isCredentialChanged ? "Changed" : "Verified" : "Submitted" : "Not Submitted"}
                                </span>
                ...
                <div className='space-y-4'>
                  <div className='grid grid-cols-2 gap-2 text-sm'>
                    <div className='flex items-center space-x-2 '>
                      ...
                      <span className=''> {formatNumber(listing.followers_count)}followers</span>
                    </div>
