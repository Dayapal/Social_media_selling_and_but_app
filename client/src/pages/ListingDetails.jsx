...
import { ArrowLeftIcon, ArrowUpRightFromSquare, ArrowUpRightFromSquareIcon, Calendar, CheckCircle2, ChevronLeftIcon, ChevronRightIcon, DollarSignIcon, Eye, LineChart, Loader2Icon, Users } from 'lucide-react';
            ...
            <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div >
                  ...
                  >@{listing.username} • {listing.platform?.charAt(0).toUpperCase() + listing.platform?.slice(1)}</p>

                  <div className='flex gap-2 mt-2'>
                    {listing.verified && (
                      <span className='flex
                     items-center text-xs
                     bg-indigo-50 text-indigo-600 px-2 py-1 rounded-md'>
                    ...
                    {listing.monetized && (
                      <span className='flex
                     items-center text-xs
                     bg-green-50 text-green-600 px-2 py-1 rounded-md'>
              ...
              <div className='text-right'>
                <h3>{currency} {listing.price?.toLocaleString()}</h3>
          ...
          {images.length > 0 && (
            ...
            border-gray-200 mb-5 overflow-hidden'>
              ...
              <div className='relative w-full aspect-video overflow-hidden'>
                ...
                ease-in-out' style={{ transform: `translateX(-${current * 100}%)` }}>
                ...
                <button onClick={prevSlide} className='absolute left-3 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white p-2 rounded-full
                 shadow'>
                  <ChevronLeftIcon className='w-5 h-5 text-gray-700' />
                </button>

                <button onClick={nextSlide} className='absolute right-3 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white p-2 rounded-full
                 shadow'>
