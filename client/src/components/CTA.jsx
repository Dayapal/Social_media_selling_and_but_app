      ...
      <div className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-linear-to-r from-purple-600/20 to-blue-500/30">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-linear-to-r from-[#F3EAFF] to-[#E1EFFF]">  
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="bg-linear-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent font-medium">Trusted by Dedicated </span>
                </div>
                ...
                <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">We are the 
                    leading social media marketplace that connects brands with their customers With our
