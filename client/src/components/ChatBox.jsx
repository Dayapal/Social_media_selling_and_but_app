...
const ChatBox = () => {
    ...
    const handleSendMessage = async (e) => {
        ...
        setMessages([...messages, {
            id: Date.now(), chatId: chat.id, sender_id: user.id,
    ...
    return (
        ...
        flex items-center justify-center sm:p-4">
            ...
            <div className="bg-white sm:rounded-lg shadow-2xl w-full max-w-2xl h-screen sm:h-[600px] flex flex-col">
                ...
                {/* Header */}
                <div className="bg-linear-to-r from-indigo-600 to-indigo-400 text-white p-4 
                sm:rounded-t-lg flex items-center justify-between">
                ...
                {/* Messages Container */}
                <div className="flex flex-col overflow-y-auto p-4 space-y-4 bg-gray-100 flex-1">
                        ...
                        <form onSubmit={handleSendMessage} >
                            <div className='flex items-end space-x-2'>
                                <textarea
                                    ...
                                    placeholder='Type your messsage... ' className='flex-1
                                resize-none border border-gray-300 rounded-lg px-4 py-2 
                                focus:outline-indigo-500 max-h-32' rows={1} />

                                <button disabled={!newMessage.trim() || isSending} type='submit' className='bg-indigo-600 hover:bg-indigo-700 text-white
                              p-2.5 rounded-lg disabled:opacity-50 transition-colors'>
                                    {isSending ?
