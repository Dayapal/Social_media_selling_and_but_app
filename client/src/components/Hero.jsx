        ...
        <>
            <div className=" relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-4 leading-tight md:leading-tight">
                    ...
                    </span> <span className='relative bg-linear-to-r from-[#764de1] to-indigo-600 bg-clip-text text-transparent'>with</span> Online.
                </h1>

                <p className="max-w-xl text-center text-base my-7">A secure marketplace to buy and sell Instagram, YoutTube, Twitter, Telegram and more -fast, safe and hassle-free.</p>
